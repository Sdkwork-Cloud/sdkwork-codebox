...
//!
//! Parses codebox:// URLs into DeepLinkImportRequest structures.
...
/// Parse a codebox:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// codebox://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "codebox" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'codebox', got '{scheme}'"
        )));
    }
