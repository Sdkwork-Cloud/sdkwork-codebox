...
This directory is the local SDKWork component contract for `@sdkwork/codebox-integration`.

- Component root: `sdkwork-codebox/packages/sdkwork-codebox-integration`
