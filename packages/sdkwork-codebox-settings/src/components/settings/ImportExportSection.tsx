      ...
      <div className="space-y-4 rounded-lg border border-border bg-muted/40 p-6">
        ...
        <div className="grid grid-cols-2 gap-4 items-stretch">
          ...
          <div className="relative">
            ...
            {selectedFile && (
              <button
                type="button"
                onClick={onClear}
                className="absolute -right-2 -top-2 z-10 flex h-6 w-6 items-center justify-center rounded-full bg-destructive text-destructive-foreground shadow-lg transition-colors hover:bg-destructive/90"
          ...
          <div>
            <Button
              type="button"
              className="h-full w-full items-center px-4 py-3"
              onClick={onExport}
            >
