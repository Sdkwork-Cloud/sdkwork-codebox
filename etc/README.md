# sdkwork-codebox Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-codebox` |
| `runtimeCode` | `codebox` |
| Config root | `/etc/sdkwork/codebox/` |
| Runtime TOML | `/etc/sdkwork/codebox/config.toml` |
| Secrets | `/etc/sdkwork/codebox/secrets/` |
| Override | `SDKWORK_CODEBOX_CONFIG_FILE` |
