> Migrated from `docs/release-notes/v3.6.1-en.md` on 2026-06-24.
> Owner: SDKWork maintainers

> Stability improvements and user experience optimization (based on v3.6.0)

**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/codebox/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- Download `CodeBox-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `CodeBox-v3.6.1-Windows.msi`
- **Portable**: `CodeBox-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `CodeBox-v3.6.1-Linux.AppImage`
- **Debian**: `CodeBox-v3.6.1-Linux.deb`

---

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/farion1231/codebox/blob/main/README_ZH.md)
- [English Documentation](https://github.com/farion1231/codebox/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/farion1231/codebox/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/farion1231/codebox/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize CodeBox's configuration storage directory
...
CodeBox is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/farion1231/codebox
