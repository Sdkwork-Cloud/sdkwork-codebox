> Migrated from `docs/user-manual/zh/3-extensions/3.1-mcp.md` on 2026-06-24.
...
如果你已经在 CLI 工具中配置了 MCP 服务器，可以导入到 CodeBox：

1. 点击「导入」按钮
2. 选择要导入的应用（Claude/Codex/Gemini/OpenCode）
3. CodeBox 会读取现有配置并导入
