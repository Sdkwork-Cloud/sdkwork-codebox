> Migrated from `docs/user-manual/en/2-providers/2.2-switch.md` on 2026-06-24.
...
2. CodeBox updates the configuration file
...
1. Right-click the CodeBox icon in the system tray
...
When switching providers, CodeBox modifies the following files:
