> Migrated from `docs/release-notes/v3.12.1-en.md` on 2026-06-24.
...
CodeBox v3.12.1 is a patch release focused on stability improvements and bug fixes. It resolves a Common Config modal infinite reopen loop, a WebDAV sync foreign key constraint failure, and several i18n interpolation issues. It also adds **StepFun** provider presets, **OpenClaw input type selection** and **authHeader** support, upgrades the default Gemini model to **3.1-pro**, and welcomes four new sponsor partners.
...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `CodeBox-v3.12.1-Windows.msi`            | **Recommended** - MSI installer with auto-update     |
| `CodeBox-v3.12.1-Windows-Portable.zip`   | Portable version, extract and run, no registry write |

### macOS

| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `CodeBox-v3.12.1-macOS.zip`      | **Recommended** - Extract and drag to Applications, Universal Binary |
| `CodeBox-v3.12.1-macOS.tar.gz`   | For Homebrew installation and auto-update                            |
...
| Other distributions / Unsure            | `.AppImage`        | `chmod +x CodeBox-*.AppImage && ./CodeBox-*.AppImage`              |
