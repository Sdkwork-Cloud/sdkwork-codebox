> Migrated from `docs/user-manual/en/1-getting-started/1.4-quickstart.md` on 2026-06-24.
...
- Right-click the CodeBox icon in the system tray
...
If Claude Code prompts you to **log in** or shows an onboarding wizard on first launch, enable the "Skip Claude Code first-run confirmation" option in CodeBox:

1. Open CodeBox "Settings > General"
