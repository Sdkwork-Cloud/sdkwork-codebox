> Migrated from `docs/user-manual/en/3-extensions/3.1-mcp.md` on 2026-06-24.
...
When enabling an app's toggle, CodeBox will:
...
When disabling an app's toggle, CodeBox will:
...
If you have already configured MCP servers in CLI tools, you can import them into CodeBox:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. CodeBox reads the existing configuration and imports it
