> Migrated from `docs/user-manual/ja/1-getting-started/1.4-quickstart.md` on 2026-06-24.
...
Claude Code を初めて起動するときに**ログイン**の要求や初期化ガイドが表示される場合は、CodeBox で「Claude Code の初回確認をスキップ」オプションを有効にしてください：

1. CodeBox の「設定 → 一般」を開く
