> Migrated from `docs/release-notes/v3.6.0-en.md` on 2026-06-24.
> Owner: SDKWork maintainers

## Major architecture refactoring with enhanced config sync and data protection

**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/codebox/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `CodeBox-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `CodeBox-v3.6.0-Windows.msi`
- **Portable**: `CodeBox-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `CodeBox-v3.6.0-Linux.AppImage`
- **Debian**: `CodeBox-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/farion1231/codebox/compare/v3.5.1...v3.6.0
