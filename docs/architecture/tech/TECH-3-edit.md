> Migrated from `docs/user-manual/en/2-providers/2.3-edit.md` on 2026-06-24.
...
CodeBox provides rich icon customization features:
...
This ensures CodeBox and CLI tool configurations stay in sync.
...
When adding a provider, CodeBox automatically extracts endpoint URLs from the configuration.
