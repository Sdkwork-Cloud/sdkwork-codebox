> Migrated from `docs/release-notes/v3.6.0-zh.md` on 2026-06-24.
...
- 从下方 [Assets](#assets) 下载 `CodeBox-v3.6.0-macOS.zip`

> **注意**：由于作者没有苹果开发者账号，首次打开可能出现"未知开发者"警告。请前往"系统设置" → "隐私与安全性" → 点击"仍要打开"

### Windows

- **安装包**：`CodeBox-v3.6.0-Windows.msi`
- **便携版**：`CodeBox-v3.6.0-Windows-Portable.zip`
...
**完整变更记录**: https://github.com/farion1231/codebox/compare/v3.5.1...v3.6.0
