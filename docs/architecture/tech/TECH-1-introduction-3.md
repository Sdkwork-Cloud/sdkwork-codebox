> Migrated from `docs/user-manual/zh/1-getting-started/1.1-introduction.md` on 2026-06-24.
> Owner: SDKWork maintainers

## 什么是 CodeBox

CodeBox 是一款跨平台桌面应用，专为使用 AI 编程工具的开发者设计。它帮助你统一管理 **Claude Code**、**Codex**、**Gemini CLI**、**OpenCode** 和 **OpenClaw** 五大 AI 编程工具的配置。
