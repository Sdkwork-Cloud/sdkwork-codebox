> Migrated from `docs/user-manual/ja/4-proxy/4.2-takeover.md` on 2026-06-24.
> Owner: SDKWork maintainers

## 機能説明

アプリケーション接管とは、CodeBox のプロキシが特定アプリの API リクエストを接管することです。
...
接管を有効にすると、CodeBox はアプリの設定ファイルを変更し、API エンドポイントをローカルプロキシに向けます。
...
接管を有効にする前に、CodeBox は元の設定をバックアップし、無効化時に復元します。
