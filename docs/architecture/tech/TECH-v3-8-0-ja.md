> Migrated from `docs/release-notes/v3.8.0-ja.md` on 2026-06-24.
...
CodeBox v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/farion1231/codebox/releases/latest) から入手:

- **Windows**: `CodeBox-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `CodeBox-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `CodeBox-v3.8.0-Linux.AppImage` または `.deb`
...
[登録時に「codebox」で 10% オフ](https://www.packyapi.com/register?aff=codebox)
...
- **Issue**: [GitHub Issues](https://github.com/farion1231/codebox/issues)
