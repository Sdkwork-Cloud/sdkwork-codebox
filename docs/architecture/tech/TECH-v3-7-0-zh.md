> Migrated from `docs/release-notes/v3.7.0-zh.md` on 2026-06-24.
...
CodeBox v3.7.0 新增六大核心功能，新增超过 18,000 行代码。
...
- **Windows**：`CodeBox-v3.7.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`CodeBox-v3.7.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`CodeBox-v3.7.0-Linux.AppImage` 或 `.deb`
...
[使用 "codebox" 代码注册可享受 10% 折扣](https://www.packyapi.com/register?aff=codebox)
