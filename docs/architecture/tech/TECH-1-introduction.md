> Migrated from `docs/user-manual/en/1-getting-started/1.1-introduction.md` on 2026-06-24.
> Owner: SDKWork maintainers

## What is CodeBox

CodeBox is a cross-platform desktop application designed for developers who use AI coding tools. It helps you centrally manage configurations for five major AI coding tools: **Claude Code**, **Codex**, **Gemini CLI**, **OpenCode**, and **OpenClaw**.
...
CodeBox solves these problems through a unified interface.
...
CodeBox is built with a modern technology stack:
