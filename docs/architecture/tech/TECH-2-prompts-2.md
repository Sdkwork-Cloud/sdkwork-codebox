> Migrated from `docs/user-manual/ja/3-extensions/3.2-prompts.md` on 2026-06-24.
...
CodeBox は、手動での変更を失わないようにスマートバックフィル保護機能を提供しています。
...
```
codebox://import/prompt?data=<Base64 エンコードされたプリセット>
```
