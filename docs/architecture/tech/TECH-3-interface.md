> Migrated from `docs/user-manual/en/1-getting-started/1.3-interface.md` on 2026-06-24.
...
CodeBox displays an icon in the system tray, providing quick access to operations.
