> Migrated from `docs/user-manual/en/4-proxy/4.1-service.md` on 2026-06-24.
...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CodeBox)
...
After starting the proxy and enabling app takeover, CodeBox modifies app configurations:
...
When stopping the proxy, CodeBox will:
