> Migrated from `docs/user-manual/ja/2-providers/2.3-edit.md` on 2026-06-24.
...
CodeBox は豊富なアイコンカスタマイズ機能を提供しています：
...
これにより、CodeBox と CLI ツールの設定が常に同期されます。
...
プロバイダーの追加時に、CodeBox は設定からエンドポイントアドレスを自動抽出します。
