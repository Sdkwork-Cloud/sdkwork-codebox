> Migrated from `docs/user-manual/zh/4-proxy/4.2-takeover.md` on 2026-06-24.
> Owner: SDKWork maintainers

## 功能说明

应用接管是指让 CodeBox 代理接管特定应用的 API 请求。
...
开启接管后，CodeBox 会修改应用的配置文件，将 API 端点指向本地代理。
