> Migrated from `docs/user-manual/en/3-extensions/3.2-prompts.md` on 2026-06-24.
...
CodeBox provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
codebox://import/prompt?data=<base64-encoded preset>
```
