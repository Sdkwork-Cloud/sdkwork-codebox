> Migrated from `docs/user-manual/ja/2-providers/2.2-switch.md` on 2026-06-24.
...
プロバイダーを切り替える際、CodeBox は以下のファイルを変更します：
