> Migrated from `docs/release-notes/v3.8.0-en.md` on 2026-06-24.
...
CodeBox v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `CodeBox-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `CodeBox-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `CodeBox-v3.8.0-Linux.AppImage` or `.deb`
...
[Use code "codebox" for 10% off registration](https://www.packyapi.com/register?aff=codebox)
...
- **Issue Reports**: [GitHub Issues](https://github.com/farion1231/codebox/issues)
