> Migrated from `docs/user-manual/en/3-extensions/3.3-skills.md` on 2026-06-24.
...
CodeBox comes pre-configured with the following GitHub repositories:
...
CodeBox provides powerful search and filter features:
