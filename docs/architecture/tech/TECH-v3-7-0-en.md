> Migrated from `docs/release-notes/v3.7.0-en.md` on 2026-06-24.
...
CodeBox v3.7.0 introduces six major features with over 18,000 lines of new code.
...
- **Windows**: `CodeBox-v3.7.0-Windows.msi` or `-Portable.zip`
- **macOS**: `CodeBox-v3.7.0-macOS.tar.gz` or `.zip`
- **Linux**: `CodeBox-v3.7.0-Linux.AppImage` or `.deb`
