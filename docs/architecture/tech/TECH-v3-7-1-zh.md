> Migrated from `docs/release-notes/v3.7.1-zh.md` on 2026-06-24.
...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S codebox-bin`
...
访问 [Releases](https://github.com/farion1231/codebox/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/farion1231/codebox/releases/latest) 下载：

- **Windows**：`CodeBox-Windows.msi` 或 `-Portable.zip`
- **macOS**：`CodeBox-macOS.tar.gz` 或 `.zip`
- **Linux**：`CodeBox-Linux.AppImage` 或 `.deb`
...
[使用 "codebox" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=codebox)
...
- **问题反馈**：[GitHub Issues](https://github.com/farion1231/codebox/issues)
- **讨论**：[GitHub Discussions](https://github.com/farion1231/codebox/discussions)
