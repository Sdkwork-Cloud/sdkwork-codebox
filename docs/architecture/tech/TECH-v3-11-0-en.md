> Migrated from `docs/release-notes/v3.11.0-en.md` on 2026-06-24.
...
| File                                     | Description                                          |
| ---------------------------------------- | ---------------------------------------------------- |
| `CodeBox-v3.11.0-Windows.msi`          | **Recommended** - MSI installer with auto-update     |
| `CodeBox-v3.11.0-Windows-Portable.zip` | Portable version, extract and run, no registry write |

### macOS

| File                             | Description                                                          |
| -------------------------------- | -------------------------------------------------------------------- |
| `CodeBox-v3.11.0-macOS.zip`    | **Recommended** - Extract and drag to Applications, Universal Binary |
| `CodeBox-v3.11.0-macOS.tar.gz` | For Homebrew installation and auto-update                            |
