> Migrated from `docs/release-notes/v3.7.1-en.md` on 2026-06-24.
...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S codebox-bin`
...
Visit [Releases](https://github.com/farion1231/codebox/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `codebox://` protocol
...
v3.7.0 represents a shift in CodeBox's positioning:
...
Visit [Releases](https://github.com/farion1231/codebox/releases/latest) to download:

- **Windows**: `CodeBox-Windows.msi` or `-Portable.zip`
- **macOS**: `CodeBox-macOS.tar.gz` or `.zip`
- **Linux**: `CodeBox-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S codebox-bin`
...
[Register with "codebox" code for 10% discount](https://www.packyapi.com/register?aff=codebox)
...
- **Issues**: [GitHub Issues](https://github.com/farion1231/codebox/issues)
- **Discussions**: [GitHub Discussions](https://github.com/farion1231/codebox/discussions)
