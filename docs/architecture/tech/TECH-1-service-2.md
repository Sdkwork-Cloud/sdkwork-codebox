> Migrated from `docs/user-manual/ja/4-proxy/4.1-service.md` on 2026-06-24.
...
sequenceDiagram
    ...
    participant Proxy as ローカルプロキシ (CodeBox)
...
プロキシを起動してアプリケーション接管を有効にすると、CodeBox はアプリの設定を変更します：
