> Migrated from `docs/user-manual/zh/1-getting-started/1.4-quickstart.md` on 2026-06-24.
...
如果 Claude Code 首次启动时提示需要**登录**或显示初始化引导，请在 CodeBox 中开启「跳过 Claude Code 初次安装确认」选项：
