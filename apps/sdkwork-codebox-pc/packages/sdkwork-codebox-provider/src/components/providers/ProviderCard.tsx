  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex w-full flex-col gap-3 xl:ml-auto xl:w-auto xl:min-w-[360px] xl:items-end">
          <div className="flex min-h-8 w-full items-center justify-end gap-1 text-right">
            {hasMultiplePlans ? (
          ...
          <div
            data-tauri-no-drag
            className="relative z-10 flex w-full justify-end rounded-2xl border border-border/60 bg-background/78 p-1.5 shadow-sm shadow-black/5 backdrop-blur-sm"
          >
            <ProviderActions
              appId={appId}
              isCurrent={isCurrent}
