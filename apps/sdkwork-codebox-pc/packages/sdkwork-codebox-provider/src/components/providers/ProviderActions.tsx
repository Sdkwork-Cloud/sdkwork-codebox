    ...
    >
      {appId === "openclaw" && isInConfig && onSetAsDefault && (
        <Button
          ...
          onClick={isDefaultModel ? undefined : withAction(onSetAsDefault)}
      ...
      <Button
        ...
        onClick={withAction(handleMainButtonClick)}
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          ...
          size="icon"
          variant="ghost"
          onClick={withAction(onDuplicate)}
        ...
        <Button
          ...
          size="icon"
          variant="ghost"
          onClick={withAction(onConfigureUsage)}
        ...
        {onOpenTerminal && (
          <Button
            ...
            size="icon"
            variant="ghost"
            onClick={withAction(onOpenTerminal)}
        ...
        <Button
          ...
          size="icon"
          variant="ghost"
          onClick={canDelete ? withAction(onDelete) : undefined}
