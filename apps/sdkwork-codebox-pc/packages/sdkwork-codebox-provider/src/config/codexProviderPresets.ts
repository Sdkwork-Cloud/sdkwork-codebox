...
requires_openai_auth = true`,
  ...
  },
  {
    ...
    apiKeyUrl: "https://www.packyapi.com/register?aff=codebox",
    category: "third_party",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "packycode",
  ...
  },
  {
    ...
    apiKeyUrl: "https://cubence.com/signup?code=CODEBOX&source=codebox",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "cubence",
  ...
  },
  {
    ...
    apiKeyUrl: "https://aigocode.com/invite/CODEBOX",
    category: "third_party",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "aigocode",
  ...
  },
  {
    ...
    apiKeyUrl: "https://www.right.codes/register?aff=CODEBOX",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "rightcode",
  ...
  },
  {
    ...
    apiKeyUrl: "https://aicoding.sh/i/CODEBOX",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "aicoding",
  ...
  },
  {
    ...
    apiKeyUrl: "https://www.crazyrouter.com/register?aff=OZcm&ref=codebox",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "crazyrouter",
  ...
  },
  {
    ...
    apiKeyUrl:
      "https://www.compshare.cn/coding-plan?ytag=GPU_YY_YX_git_codebox",
    auth: generateThirdPartyAuth(""),
    config: generateThirdPartyConfig(
      "compshare",
