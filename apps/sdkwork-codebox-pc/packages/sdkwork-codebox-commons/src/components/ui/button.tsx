  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        // 主按钮：跟随主题主色
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_16px_36px_-24px_hsl(var(--primary)/0.55)]",
        // 危险按钮：红底白字（对应旧版 danger）
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        // 轮廓按钮
        outline:
          "border border-border-default bg-background text-muted-foreground hover:border-border-hover hover:bg-accent/70 hover:text-foreground",
