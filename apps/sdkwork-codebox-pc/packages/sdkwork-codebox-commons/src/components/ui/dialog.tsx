...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    zIndex?: "base" | "nested" | "alert" | "top";
    variant?: "default" | "fullscreen" | "drawer-right";
...
>(
  (
    ...
    const variantClass = {
      ...
      "drawer-right":
        "fixed inset-y-3 right-3 flex h-[calc(100vh-1.5rem)] w-[min(1180px,calc(100vw-1.5rem))] max-w-[calc(100vw-1.5rem)] translate-x-0 translate-y-0 overflow-hidden rounded-[30px] border border-border/70 bg-background text-foreground shadow-[0_36px_96px_-48px_hsl(var(--shadow-color)/0.96)] duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-right-full",
    }[variant];
